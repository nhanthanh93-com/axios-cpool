...
var Client = /** @class */ (function () {
    function Client(baseURL, timeout) {
    ...
    Client.prototype.get = function (url, params, config) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                finalConfig = __assign(__assign({}, config), { params: params });
                return [2 /*return*/, this.instance.get(url, finalConfig)];
            });
        });
    };
    Client.prototype.post = function (url_1) {
        return __awaiter(this, arguments, void 0, function (url, data, config) {
            if (data === void 0) { data = {}; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.instance.post(url, data, config)];
            });
        });
    };
    Client.prototype.delete = function (url, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.instance.delete(url, config)];
            });
        });
    };
